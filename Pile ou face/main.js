...
function headsOrTails(){ // Création de la function headOrTails
    ...
    if (resultat == 0){  // SI dans la variable la vérification " == " et donc == à 0 alors tu affiche dans la variable result le mot Pile 
        result.innerText = "Pile";
        console.log(resultat);
    }

    else if (resultat == 1){ // Parcontre (SInon si) dans la variable la vérification " == " et donc == à 1 alors tu affiche dans la variable result le mot Face 
